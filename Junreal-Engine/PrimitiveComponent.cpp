...
void UPrimitiveComponent::Serialize(bool bIsLoading, FComponentData& InOut)
{
    if (bIsLoading)
    {
        ...
        SetRelativeRotation(SceneRotUtil::QuatFromEulerZYX_Deg(InOut.RelativeRotation));
    ...
    else
    {
        ...
        InOut.RelativeRotation = SceneRotUtil::EulerZYX_Deg_FromQuat(GetRelativeRotation());
