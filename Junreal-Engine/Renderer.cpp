...
{
	INSIGHTS_SCOPE(GStat_RenderSceneDepthPass);
	INSIGHTS_GPU_SCOPE(GStat_GPU_RenderSceneDepthPass);
	// +-+ Set Render State +-+
...
void URenderer::RenderScene(UWorld* World, ACameraActor* Camera, FViewport* Viewport)
{
	...
	INSIGHTS_GPU_SCOPE(GStat_GPU_RenderScene);
	...
	case EViewModeIndex::VMI_Wireframe:
	{
		...
		{
			INSIGHTS_SCOPE(GStat_CullLights);
			INSIGHTS_GPU_SCOPE(GStat_GPU_CullLights);
...
{
	INSIGHTS_SCOPE(GStat_RenderFogPass);
	INSIGHTS_GPU_SCOPE(GStat_GPU_RenderFogPass);
